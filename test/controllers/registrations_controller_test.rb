...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { car_id: @registration.car_id, expire_date: @registration.expire_date } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { car_id: @registration.car_id, expire_date: @registration.expire_date } }
